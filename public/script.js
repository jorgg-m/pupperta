(function () {
	...
	// Hugo CMS generates all content - no mock data needed

	// No card generation needed - Hugo CMS handles all content

	// Hugo CMS handles all content loading - no infinite scroll needed
